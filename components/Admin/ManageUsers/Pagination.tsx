    ...
    return (
        ...
        <nav className='bg-[#F6F8FC] p-1' aria-label="pagination-users">
            <ul className="inline-flex items-center gap-2 bg-[#F6F8FC]">
                ...
                <li>
                    <a href="#" className="py-1 px-2 leading-tight text-gray-500 bg-white hover:bg-gray-100 hover:text-gray-700">1</a>
                </li>
                <li>
                    <a href="#" className="py-1 px-2 leading-tight text-white bg-black hover:bg-gray-100 hover:text-gray-700">2</a>
                </li>
                <li>

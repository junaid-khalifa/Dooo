        ...
        <div className='grid grid-cols-3 mt-12'>
            ...
            <div className='col-span-2'>
                ...
                <div className="flex justify-between gap-4 flex-wrap my-4">
                    <div className="bg-[#1E1E1F] h-28 w-48 rounded-xl flex justify-center items-center gap-2">
                    ...
                    <div className="bg-[#F2F5FA] h-28 w-48 rounded-xl flex justify-center items-center gap-2">
